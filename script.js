...
const people = {
  ...
  person_66: {
    name: "naina sonkar",
    about:
      "Hey beutiful! yarr tumhare liye yaha ni bolunga Personal me baat krte hain ok!",
  },
  person_67: {
    name: "manisha lubana",
    about: "Hello Manisha Di! kaisi ho aap?",
...
submitBtm.addEventListener("click", function () {
  ...
  let inputDirect = input.value;
  let inputText = inputDirect.toLowerCase();
  let found = false;
  ...
  if (inputText !== "") {
    ...
    outputText.textContent = `input correct name`;
